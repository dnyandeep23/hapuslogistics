...
"
  ...
  "
    ...
    md:px-10 md:py-8">
          ...
          <p className="text-white font-bold text-2xl md:text-3xl mb-3">Operator Register</p>
      ...
      focus:outline-none`}
            ...
            <div className="flex justify-between items-center text-xs md:text-sm text-white/80 mt-2">
              <span>Already have an account? <Link href="/operator/login" className="text-[#D5E400] underline cursor-pointer">Log In</Link></span>
            </div>
      ...
      disabled:opacity-50" disabled={loading}>
          ...
          <button
            ...
            className=" relative flex mt-4 mx-auto
    bg-[#404811]/60
    px-10 md:px-24 py-3
    rounded-full
