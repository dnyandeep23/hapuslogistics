...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(205,214,69,0.14),transparent_28%),linear-gradient(180deg,#11160f_0%,#1a2017_42%,#0e120c_100%)] text-white">
      <Header />
