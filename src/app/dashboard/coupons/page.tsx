...
export default function DashboardCouponsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[#E4E67A]">Coupon Center</h1>
        <p className="mt-1 text-sm text-white/70">Manage platform discount coupons.</p>
      </div>
      <SuperAdminCouponBannerSection mode="coupon" />
    </div>
  );
}
